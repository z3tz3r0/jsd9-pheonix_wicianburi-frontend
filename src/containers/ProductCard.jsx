...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className='flex flex-col h-full bg-white rounded-lg shadow-md w-45'>
      <img
        src={product.image}
        alt={product.name}
      ...
      <div className='flex flex-col justify-between flex-grow p-4'>
        ...
        <div className='flex items-center justify-between mt-2'>
          ...
          {/* Right: Cart icon*/}
          <button className='ml-1.2 bg-gray-200 p-1.5 rounded-full hover:bg-gray-300 cursor-pointer'>
