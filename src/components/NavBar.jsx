  ...
  return (
    <div className="absolute z-10 mt-2 translate-x-1/2 right-1/2 top-full user-popup-content">
      <div className="relative p-4 rounded-md shadow-lg -right-2 top-1 bg-primary w-52">
        <NavLink
          className="flex items-center py-2 hover:text-accent"
          to="/profile"
        >
    ...
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="relative flex flex-col w-64 h-full transition-transform transform shadow-xl bg-primary duration-600">
        <ul className="flex-1 p-4">
          ...
          <li className="py-3 hover:text-accent">
            <NavLink to="products" onClick={onClose} className="block">
              ผลิตภัณฑ์
            </NavLink>
          </li>
          <li className="py-3 hover:text-accent">
...
const NavBar = () => {
  ...
  useEffect(() => {
    ...
    const handleClickOutside = (event) => {
      if (
        ...
        !event.target.closest(".user-popup-content")
      ) {
        closeUserPopup();
      }
    };
  ...
  return (
    <>
        ...
        <nav className="z-10 flex items-center justify-between h-16 sm:w-7xl ">
          <div className="flex ml-4 sm:items-center">
            <Link to="/" className="flex items-center">
              <img
                className="w-6"
                src="/assets/logo-all_rice-black.svg"
                alt="All Rice Logo"
              />
          ...
          <div className="flex items-center mr-4">
            ...
            <div
              className="relative mx-6 hover:cursor-pointer profile-icon-container"
      ...
      {isAuthPageOpen && (
        <div ref={authPageRef}>
          <Backdrop open={isAuthPageOpen} onClick={openAuthPage}></Backdrop>
