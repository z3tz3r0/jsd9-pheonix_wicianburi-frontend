        ...
        if (ai && !chatRef.current) {
            ...
            try {
                chatRef.current = ai.chats.create({
                    ...
                    history: messages,
                    config: {
                        systemInstruction: "คุณคือผู้ช่วย AI ประจำเว็บไซต์ขายข้าว All Rice inc. (ออลไรซ์) แห่งนี้ เช่น เวลาเปิดปิด ที่ตั้ง โปรโมชั่น หรือข้อมูลอื่นๆ ที่มีบนเว็บ เน้นตอบให้กระชับ เป็นกันเองเหมือนคุยกับคนจริง ๆ ถ้าไม่รู้หรือไม่แน่ใจ ให้บอกว่าไม่ทราบข้อมูล หรือแนะนำให้ติดต่อร้านโดยตรง"
                    },
                })
